...
[![Godoc](https://img.shields.io/badge/go-documentation-blue.svg?style=flat-square)](https://godoc.org/github.com/polygon-io/etcd/clientv3)
...
```bash
go get github.com/polygon-io/etcd/clientv3
```
...
2. gRPC error: see [api/v3rpc/rpctypes](https://godoc.org/github.com/polygon-io/etcd/etcdserver/api/v3rpc/rpctypes).
...
The [namespace](https://godoc.org/github.com/polygon-io/etcd/clientv3/namespace) package provides `clientv3` interface wrappers to transparently isolate client requests to a user-defined prefix.
...
More code examples can be found at [GoDoc](https://godoc.org/github.com/polygon-io/etcd/clientv3).
