...
- Move [`"github.com/coreos/etcd"`](https://github.com/etcd-io/etcd/issues/9965) to [`"github.com/etcd-io/etcd"`](https://github.com/etcd-io/etcd/issues/9965).
  ...
  - e.g. `import "github.com/polygon-io/etcd/raft"`.
...
- Move internal packages to `etcdserver`.
  - `"github.com/coreos/etcd/alarm"` to `"github.com/polygon-io/etcd/etcdserver/api/v3alarm"`.
  - `"github.com/coreos/etcd/compactor"` to `"github.com/polygon-io/etcd/etcdserver/api/v3compactor"`.
  - `"github.com/coreos/etcd/discovery"` to `"github.com/polygon-io/etcd/etcdserver/api/v2discovery"`.
  - `"github.com/coreos/etcd/etcdserver/auth"` to `"github.com/polygon-io/etcd/etcdserver/api/v2auth"`.
  - `"github.com/coreos/etcd/etcdserver/membership"` to `"github.com/polygon-io/etcd/etcdserver/api/membership"`.
  - `"github.com/coreos/etcd/etcdserver/stats"` to `"github.com/polygon-io/etcd/etcdserver/api/v2stats"`.
  - `"github.com/coreos/etcd/error"` to `"github.com/polygon-io/etcd/etcdserver/api/v2error"`.
  - `"github.com/coreos/etcd/rafthttp"` to `"github.com/polygon-io/etcd/etcdserver/api/rafthttp"`.
  - `"github.com/coreos/etcd/snap"` to `"github.com/polygon-io/etcd/etcdserver/api/snap"`.
  - `"github.com/coreos/etcd/store"` to `"github.com/polygon-io/etcd/etcdserver/api/v2store"`.
