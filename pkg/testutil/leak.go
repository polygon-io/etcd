...
running(leaking) after all tests.
	...
	import "github.com/polygon-io/etcd/v3/pkg/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "github.com/polygon-io/etcd/v3/pkg/testutil.interestingGoroutines") ||
			strings.Contains(stack, "github.com/polygon-io/etcd/v3/pkg/logutil.(*MergeLogger).outputLoop") ||
